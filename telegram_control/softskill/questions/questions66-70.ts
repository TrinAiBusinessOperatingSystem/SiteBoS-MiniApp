...
export const questions66to70: Question[] = [
  ...
  {
    num: 69,
    scenario: "Come inizi un nuovo compito: ti lanci subito o aspetti?",
    instructions: [
      "Immagine di un atleta scattante sulla linea di partenza, pronto a lanciarsi subito nella gara.",
      "Immagine di un architetto che osserva attentamente un progetto prima di iniziare i lavori, approccio riflessivo.",
      "Immagine di una persona che guarda l'orologio con aria indecisa, esitazione e rinvio.",
      "Immagine di una strada bloccata con un cartello di divieto di accesso, evitamento totale dell'inizio."
    ],
    captions: [
      "Pronto al Via",
      "Studio Preliminare",
    ...
    options: [
      {
        value: "Pronto al Via",
        text: "(Positivo: massima proattività e tempestività d'azione, attitudine a cogliere le opportunità con velocità di esecuzione superiore) (Negativo: rischio di impulsività e scarsa cura dei dettagli iniziali, potenziale inefficienza dovuta a errori per fretta e mancanza di visione d'insieme)."
      },
      {
        value: "Studio Preliminare",
        text: "(Positivo: approccio analitico e metodico volto a massimizzare la qualità del risultato attraverso una pianificazione rigorosa) (Negativo: rischio di paralisi da analisi e lentezza eccessiva nel time-to-market, potenziale perdita di opportunità per eccessivo perfezionismo preparatorio)."
      },
      {
        value: "Partenza Rimandata",
        text: "(Positivo: attitudine alla riflessione profonda e alla maturazione dell'intento prima dell'impegno operativo, cautela strategica) (Negativo: tendenza critica alla procrastinazione e all'evitamento delle responsabilità, rischio di accumulo di ritardi e perdita di slancio motivazionale)."
      },
      {
        value: "Partenza Vietata",
        text: "(Positivo: capacità di delega radicale o di rifiuto consapevole di attività non prioritarie per proteggere il focus strategico) (Negativo: immobilismo cronico e rifiuto patologico della sfida, totale mancanza di iniziativa e inefficacia nella gestione dei compiti minimi)."
      }
    ],
    softSkill: "Autodisciplina, GestioneDelTempo",
    characteristics: "Tendenza alla Procrastinazione, Iniziativa, Motivazione"
  },
  {
    num: 70,
