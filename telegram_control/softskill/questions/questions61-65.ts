...
export const questions61to65: Question[] = [
  ...
  },
  {
    ...
    instructions: [
      ...
      "Immagine di una persona che ride apertamente e di gusto,  reazione spontanea e divertita.",
      "Immagine di una persona che scappa via disgustata tappandosi il naso,  disgusto e rifiuto totale."
    ],
    captions: [
      "Niente, Immobile",
      "Imbarazzo Controllato",
      "Mi Faccio una Risata",
      "Fuga Disgustata"
    ],
    options: [
      {
        value: "Niente, Immobile",
        text: "(Positivo: eccellente autocontrollo emotivo e tutela della dignità altrui attraverso la neutralità, capacità di mantenere il decoro in situazioni impreviste) (Negativo: distacco emotivo che può apparire freddezza o indifferenza robotica, mancanza di reattività empatica alle frizioni sociali)."
      },
      {
        value: "Imbarazzo Controllato",
        text: "(Positivo: rispetto delle norme di bon ton e sensibilità sociale, attitudine a gestire il disagio con discrezione professionale senza offendere) (Negativo: gestione formale che non risolve la tensione, rischio di apparire eccessivamente legati alle convenzioni e poco spontanei)."
      },
      {
        value: "Mi Faccio una Risata",
        text: "(Positivo: naturalezza e capacità di sdrammatizzare le contingenze umane, attitudine a rompere la tensione con autoironia e cameratismo) (Negativo: potenziale mancanza di tatto o percezione di scarsa professionalità in contesti che richiederebbero maggiore contegno o discrezione)."
      },
      {
        value: "Fuga Disgustata",
        text: "(Positivo: espressione onesta e non filtrata del proprio disagio sensoriale, coerenza con elevati standard di igiene e decoro personale) (Negativo: reazione sproporzionata e mancanza di intelligenza emotiva nella gestione dell'imbarazzo altrui, incapacità di gestire lo stress situazionale)."
      }
    ],
  ...
  },
  {
    ...
    instructions: [
      ...
      {
        value: "Sentiero",
        text: "(Positivo: flessibilità tattica e ricerca di soluzioni di compromesso sostenibili tra efficacia e rispetto formale delle regole) (Negativo: ambiguità morale latente e scarsa solidità nei principi, rischio di scivolare verso condotte eticamente discutibili per convenienza)."
      },
      {
        value: "Salita",
        text: "(Positivo: integrità valoriale solida e rifiuto dei compromessi facili, attitudine a perseguire la qualità e la correttezza anche a costo di maggiore sforzo) (Negativo: ridotta velocità decisionale e rischio di inefficienza operativa, potenziale rigidità che rallenta il raggiungimento degli obiettivi)."
      },
      {
        value: "Scalata",
        text: "(Positivo: integrità etica assoluta e coerenza granitica con i propri principi, leadership morale ineccepibile e orientamento all'eccellenza etica) (Negativo: rischio di paralisi operativa per eccessivo scrupolo dogmatico, inefficienza critica dovuta a una visione idealistica non sempre sostenibile)."
      }
    ],
    softSkill: "ProblemSolving, Integrita",
    characteristics: "Scelta Etica, Integrità, Approccio alla Risoluzione dei Problemi"
  }
];
