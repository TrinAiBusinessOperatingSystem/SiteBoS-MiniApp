const DVRPrintEngine = {
    ...
    generateAndPrint: async function (tenant, catalog, checklistState) {
        ...
        try {
            ...
            // Telegram Mobile: apri il PDF nella finestra corrente o in una nuova scheda
            ...
            // Invio del PDF al webhook (asincrono e non bloccante)
            try {
                ...
                fetch(webhookUrl, {
                    ...
                    console.log('PDF upload response:', response.status);
                }).catch(uploadErr => {
                    console.error('PDF upload fetch error:', uploadErr);
                });
            } catch (base64Err) {
                console.error('PDF Base64 processing error:', base64Err);
            }
